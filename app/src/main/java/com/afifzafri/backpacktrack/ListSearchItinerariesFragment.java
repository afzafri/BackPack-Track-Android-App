 ...
 */
public class ListSearchItinerariesFragment extends Fragment {
    ...
    public ListSearchItinerariesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_list_search_itineraries, container, false);
        ...
        apiEndpoint = null;
        if(sort == 1) {
            apiEndpoint = "searchItineraries";
        } else if(sort == 2) {
            apiEndpoint = "searchTopItineraries";
        } else if(sort == 3) {
            apiEndpoint = "searchTrendingItineraries";
        } else {
            apiEndpoint = "searchItineraries";
        }
        ...
        firstLoadData(view, query, access_token, apiEndpoint);
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if (!recyclerView.canScrollVertically(RecyclerView.FOCUS_DOWN)) {
                        ...
                        if (itShouldLoadMore) {
                            loadMore(view, query, access_token, apiEndpoint);
                        }
                    }
        ...
        mSwipeRefreshLayout.setOnRefreshListener(
                new SwipeRefreshLayout.OnRefreshListener() {
                    ...
                    public void onRefresh() {
                        ...
                        ft.detach(ListSearchItinerariesFragment.this).attach(ListSearchItinerariesFragment.this).commit();
    ...
    private void firstLoadData(View view, String query, final String access_token, String apiEndpoint) {
        // get UI elements
        ...
        JsonObjectRequest countriesListRequest = new JsonObjectRequest(Request.Method.GET, AppHelper.baseurl + "/api/"+apiEndpoint+"/"+query, null,
    ...
    private void loadMore(View view, String query, final String access_token, String apiEndpoint) {
        // get UI elements
        ...
        // Request a string response from the provided URL.
        JsonObjectRequest countriesListRequest = new JsonObjectRequest(Request.Method.GET, AppHelper.baseurl + "/api/"+apiEndpoint+"/"+query+"?page="+lastPage, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
