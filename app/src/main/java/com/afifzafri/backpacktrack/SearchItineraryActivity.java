...
public class SearchItineraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstLoadData(query, access_token);
    ...
    private void firstLoadData(String query, final String access_token) {
        // get UI elements
        ...
        JsonObjectRequest itinerariesListRequest = new JsonObjectRequest(Request.Method.GET, AppHelper.baseurl + "/api/searchItineraries/"+query, null,
        ...
        VolleySingleton.getInstance(getBaseContext()).addToRequestQueue(itinerariesListRequest);

        lastPage++; // increment the page number
    }

    private void loadMore(String query, final String access_token) {
        // get UI elements
        ...
        // Request a string response from the provided URL.
        JsonObjectRequest itinerariesListRequest = new JsonObjectRequest(Request.Method.GET, AppHelper.baseurl + "/api/searchItineraries/"+query+"?page="+lastPage, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
